...
from fairseq.models.itnet_model import ItransformerConfig, CnnEncoderBase
from fairseq.models.itnet_model.itransformer_decoder import TransformerDecoderBase
...
class ItransformerModelBase(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, cfg, task):
        ...
        cfg.encoder.layers = eval(cfg.encoder.layers)
        ...
        encoder = cls.build_encoder(cfg, src_dict, cfg.encoder.layers)
